                ...
                <tr>
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        @if($user->id !== auth()->id())
                            ...
                            />
                        @else
                            <a href="{{ route('admin.users.edit', $user) }}" class="bg-blue-100 text-blue-700 hover:bg-blue-200 px-3 py-1.5 rounded-md text-sm font-medium transition duration-200 flex items-center inline-block">

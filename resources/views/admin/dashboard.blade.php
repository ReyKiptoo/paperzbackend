...
<head>
    ...
    <title>Paperz Admin Dashboard</title>
                    ...
                    <div class="row mb-4">
                        <div class="col-md-3">
                            <div class="card stats-card">
                                <div class="stats-number">{{ $collegeCount }}</div>
                                <div class="stats-label">Colleges</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card stats-card">
                                <div class="stats-number">{{ $courseCount }}</div>
                                <div class="stats-label">Courses</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card stats-card">
                                <div class="stats-number">{{ $unitCount }}</div>
                                <div class="stats-label">Units</div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card stats-card">
                                <div class="stats-number">{{ $paperCount }}</div>
